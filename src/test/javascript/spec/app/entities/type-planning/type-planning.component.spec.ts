...
import { TypePlanningComponent } from 'app/entities/type-planning/type-planning.component';
...
describe('Component Tests', () => {
  describe('TypePlanning Management Component', () => {
    let comp: TypePlanningComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypePlanningComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typePlannings && comp.typePlannings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
