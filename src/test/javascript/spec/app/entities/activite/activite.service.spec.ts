...
describe('Service Tests', () => {
  describe('Activite Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Activite(0, currentDate, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Activite', () => {
        const returnedFromService = Object.assign(
          {
            dateActivite: currentDate.format(DATE_FORMAT),
            heureConnexionActivite: 'BBBBBB',
            heureDeConnexionActivite: 'BBBBBB',
            adresseIpActivite: 'BBBBBB',
            dateCreated: currentDate.format(DATE_FORMAT),
            userCreated: 1,
            adresseMac: 'BBBBBB'
          },
