...
import { TypeFactureComponent } from 'app/entities/type-facture/type-facture.component';
...
describe('Component Tests', () => {
  describe('TypeFacture Management Component', () => {
    let comp: TypeFactureComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeFactureComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeFactures && comp.typeFactures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
