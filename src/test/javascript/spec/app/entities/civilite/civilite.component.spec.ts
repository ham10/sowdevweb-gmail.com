...
import { CiviliteComponent } from 'app/entities/civilite/civilite.component';
...
describe('Component Tests', () => {
  describe('Civilite Management Component', () => {
    let comp: CiviliteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CiviliteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.civilites && comp.civilites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
