...
import { InventaireComponent } from 'app/entities/inventaire/inventaire.component';
...
describe('Component Tests', () => {
  describe('Inventaire Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inventaires && comp.inventaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
