...
/**
 * REST controller for managing {@link com.projet.hpd.domain.Plateau}.
 */
@RestController
@RequestMapping("/api")
public class PlateauResource {
    ...
    public PlateauResource(PlateauService plateauService) {
    ...
    public ResponseEntity<List<Plateau>> getAllPlateaus(Pageable pageable) {
        ...
        Page<Plateau> page = plateauService.findAll(pageable);
