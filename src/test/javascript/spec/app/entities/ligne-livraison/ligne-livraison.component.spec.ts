...
import { LigneLivraisonComponent } from 'app/entities/ligne-livraison/ligne-livraison.component';
...
describe('Component Tests', () => {
  describe('LigneLivraison Management Component', () => {
    let comp: LigneLivraisonComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LigneLivraisonComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ligneLivraisons && comp.ligneLivraisons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
