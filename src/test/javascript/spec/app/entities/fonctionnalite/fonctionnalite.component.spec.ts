...
import { FonctionnaliteComponent } from 'app/entities/fonctionnalite/fonctionnalite.component';
...
describe('Component Tests', () => {
  describe('Fonctionnalite Management Component', () => {
    let comp: FonctionnaliteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FonctionnaliteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fonctionnalites && comp.fonctionnalites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
