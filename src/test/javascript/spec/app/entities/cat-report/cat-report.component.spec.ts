...
import { CatReportComponent } from 'app/entities/cat-report/cat-report.component';
...
describe('Component Tests', () => {
  describe('CatReport Management Component', () => {
    let comp: CatReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CatReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.catReports && comp.catReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
