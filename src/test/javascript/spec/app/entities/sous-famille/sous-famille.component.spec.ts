...
import { SousFamilleComponent } from 'app/entities/sous-famille/sous-famille.component';
...
describe('Component Tests', () => {
  describe('SousFamille Management Component', () => {
    ...
    beforeEach(() => {
      ...
      service = fixture.debugElement.injector.get(SousFamilleService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sousFamilles && comp.sousFamilles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
