...
type EntityResponseType = HttpResponse<ICivilite>;
type EntityArrayResponseType = HttpResponse<ICivilite[]>;

@Injectable({ providedIn: 'root' })
export class CiviliteService {
  public resourceUrl = SERVER_API_URL + 'api/civilites';
  ...
  update(civilite: ICivilite): Observable<EntityResponseType> {
    return this.http.put<ICivilite>(this.resourceUrl, civilite, { observe: 'response' });
  }
