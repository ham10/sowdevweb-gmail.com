...
public class RegionResourceIT {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getDateCreated()).isEqualTo(DEFAULT_DATE_CREATED);
        assertThat(testRegion.getDateUpdated()).isEqualTo(DEFAULT_DATE_UPDATED);
        assertThat(testRegion.getUserCreated()).isEqualTo(DEFAULT_USER_CREATED);
        assertThat(testRegion.getUserUpdated()).isEqualTo(DEFAULT_USER_UPDATED);
        assertThat(testRegion.getUserDeleted()).isEqualTo(DEFAULT_USER_DELETED);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codeRegion").value(hasItem(DEFAULT_CODE_REGION)))
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.codeRegion").value(DEFAULT_CODE_REGION))
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getDateCreated()).isEqualTo(UPDATED_DATE_CREATED);
        assertThat(testRegion.getDateUpdated()).isEqualTo(UPDATED_DATE_UPDATED);
        assertThat(testRegion.getUserCreated()).isEqualTo(UPDATED_USER_CREATED);
        assertThat(testRegion.getUserUpdated()).isEqualTo(UPDATED_USER_UPDATED);
        assertThat(testRegion.getUserDeleted()).isEqualTo(UPDATED_USER_DELETED);
    }
