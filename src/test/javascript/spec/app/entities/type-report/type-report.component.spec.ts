...
import { TypeReportComponent } from 'app/entities/type-report/type-report.component';
...
describe('Component Tests', () => {
  describe('TypeReport Management Component', () => {
    let comp: TypeReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeReports && comp.typeReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
