...
import { TypeUniteComponent } from 'app/entities/type-unite/type-unite.component';
...
describe('Component Tests', () => {
  describe('TypeUnite Management Component', () => {
    let comp: TypeUniteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeUniteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeUnites && comp.typeUnites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
