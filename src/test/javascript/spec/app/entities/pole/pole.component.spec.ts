...
import { PoleComponent } from 'app/entities/pole/pole.component';
import { PoleService } from 'app/entities/pole/pole.service';
import { Pole } from 'app/shared/model/pole.model';

describe('Component Tests', () => {
  describe('Pole Management Component', () => {
    let comp: PoleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PoleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.poles && comp.poles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
