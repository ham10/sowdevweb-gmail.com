...
import { TypePieceComponent } from 'app/entities/type-piece/type-piece.component';
...
describe('Component Tests', () => {
  describe('TypePiece Management Component', () => {
    let comp: TypePieceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypePieceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typePieces && comp.typePieces[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
