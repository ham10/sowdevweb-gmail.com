...
/**
 * REST controller for managing {@link com.projet.hpd.domain.TypeQuestion}.
 */
@RestController
@RequestMapping("/api")
public class TypeQuestionResource {
    ...
    public TypeQuestionResource(TypeQuestionService typeQuestionService) {
    ...
    public ResponseEntity<TypeQuestion> createTypeQuestion(@RequestBody TypeQuestion typeQuestion) throws URISyntaxException {
        ...
        TypeQuestion result = typeQuestionService.save(typeQuestion);
    ...
    /**
     * {@code PUT  /type-questions} : Updates an existing typeQuestion.
     *
    ...
    public ResponseEntity<TypeQuestion> updateTypeQuestion(@RequestBody TypeQuestion typeQuestion) throws URISyntaxException {
    ...
    public ResponseEntity<List<TypeQuestion>> getAllTypeQuestions(Pageable pageable) {
        log.debug("REST request to get a page of TypeQuestions");
        Page<TypeQuestion> page = typeQuestionService.findAll(pageable);
    ...
    public ResponseEntity<TypeQuestion> getTypeQuestion(@PathVariable Long id) {
        ...
        Optional<TypeQuestion> typeQuestion = typeQuestionService.findOne(id);
