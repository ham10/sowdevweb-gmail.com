...
import { BonDeCommandeComponent } from 'app/entities/bon-de-commande/bon-de-commande.component';
...
describe('Component Tests', () => {
  describe('BonDeCommande Management Component', () => {
    let comp: BonDeCommandeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BonDeCommandeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bonDeCommandes && comp.bonDeCommandes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
