...
/**
 * REST controller for managing {@link com.projet.hpd.domain.Rayon}.
 */
@RestController
@RequestMapping("/api")
public class RayonResource {
     ...
     */
    @PostMapping("/rayons")
    public ResponseEntity<Rayon> createRayon(@RequestBody Rayon rayon) throws URISyntaxException {
     ...
     */
    @PutMapping("/rayons")
    public ResponseEntity<Rayon> updateRayon(@RequestBody Rayon rayon) throws URISyntaxException {
     ...
     */
    @GetMapping("/rayons")
    public ResponseEntity<List<Rayon>> getAllRayons(Pageable pageable) {
