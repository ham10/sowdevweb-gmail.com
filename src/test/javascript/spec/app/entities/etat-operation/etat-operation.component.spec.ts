...
import { EtatOperationComponent } from 'app/entities/etat-operation/etat-operation.component';
...
describe('Component Tests', () => {
  describe('EtatOperation Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etatOperations && comp.etatOperations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
