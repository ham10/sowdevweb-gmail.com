...
import { EtatCaisseComponent } from 'app/entities/etat-caisse/etat-caisse.component';
...
describe('Component Tests', () => {
  describe('EtatCaisse Management Component', () => {
    let comp: EtatCaisseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtatCaisseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etatCaisses && comp.etatCaisses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
