...
/**
 * REST controller for managing {@link com.projet.hpd.domain.FicheMedical}.
 */
@RestController
@RequestMapping("/api")
public class FicheMedicalResource {
    ...
    private static final String ENTITY_NAME = "ficheMedical";
    ...
    public FicheMedicalResource(FicheMedicalService ficheMedicalService) {
        this.ficheMedicalService = ficheMedicalService;
    }
    ...
    public ResponseEntity<FicheMedical> createFicheMedical(@RequestBody FicheMedical ficheMedical) throws URISyntaxException {
        ...
        FicheMedical result = ficheMedicalService.save(ficheMedical);
        return ResponseEntity.created(new URI("/api/fiche-medicals/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /fiche-medicals} : Updates an existing ficheMedical.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/fiche-medicals")
    public ResponseEntity<FicheMedical> updateFicheMedical(@RequestBody FicheMedical ficheMedical) throws URISyntaxException {
        log.debug("REST request to update FicheMedical : {}", ficheMedical);
        if (ficheMedical.getId() == null) {
    ...
    public ResponseEntity<List<FicheMedical>> getAllFicheMedicals(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get a page of FicheMedicals");
        Page<FicheMedical> page;
        if (eagerload) {
            page = ficheMedicalService.findAllWithEagerRelationships(pageable);
        } else {
            page = ficheMedicalService.findAll(pageable);
        }
    ...
    public ResponseEntity<FicheMedical> getFicheMedical(@PathVariable Long id) {
        ...
        Optional<FicheMedical> ficheMedical = ficheMedicalService.findOne(id);
