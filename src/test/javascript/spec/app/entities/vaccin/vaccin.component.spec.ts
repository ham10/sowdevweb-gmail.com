...
import { VaccinComponent } from 'app/entities/vaccin/vaccin.component';
import { VaccinService } from 'app/entities/vaccin/vaccin.service';
import { Vaccin } from 'app/shared/model/vaccin.model';

describe('Component Tests', () => {
  describe('Vaccin Management Component', () => {
    let comp: VaccinComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VaccinComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vaccins && comp.vaccins[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
