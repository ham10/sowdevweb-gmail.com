...
public class ServicesResourceIT {
    ...
    public void createServices() throws Exception {
        ...
        assertThat(testServices.getCode()).isEqualTo(DEFAULT_CODE);
        assertThat(testServices.getLibelle()).isEqualTo(DEFAULT_LIBELLE);
        assertThat(testServices.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testServices.getDateCreated()).isEqualTo(DEFAULT_DATE_CREATED);
        assertThat(testServices.getDateUpdated()).isEqualTo(DEFAULT_DATE_UPDATED);
        assertThat(testServices.getUserCreated()).isEqualTo(DEFAULT_USER_CREATED);
        assertThat(testServices.getUserUpdated()).isEqualTo(DEFAULT_USER_UPDATED);
        assertThat(testServices.getUserDeleted()).isEqualTo(DEFAULT_USER_DELETED);
    }
    ...
    public void updateServices() throws Exception {
        ...
        Services testServices = servicesList.get(servicesList.size() - 1);
        assertThat(testServices.getCode()).isEqualTo(UPDATED_CODE);
        assertThat(testServices.getLibelle()).isEqualTo(UPDATED_LIBELLE);
        assertThat(testServices.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testServices.getDateCreated()).isEqualTo(UPDATED_DATE_CREATED);
        assertThat(testServices.getDateUpdated()).isEqualTo(UPDATED_DATE_UPDATED);
        assertThat(testServices.getUserCreated()).isEqualTo(UPDATED_USER_CREATED);
        assertThat(testServices.getUserUpdated()).isEqualTo(UPDATED_USER_UPDATED);
        assertThat(testServices.getUserDeleted()).isEqualTo(UPDATED_USER_DELETED);
    }
