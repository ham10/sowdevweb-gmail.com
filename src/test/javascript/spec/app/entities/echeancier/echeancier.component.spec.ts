...
import { EcheancierComponent } from 'app/entities/echeancier/echeancier.component';
...
describe('Component Tests', () => {
  describe('Echeancier Management Component', () => {
    let comp: EcheancierComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EcheancierComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.echeanciers && comp.echeanciers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
