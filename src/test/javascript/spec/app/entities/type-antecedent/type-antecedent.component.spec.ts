...
import { TypeAntecedentComponent } from 'app/entities/type-antecedent/type-antecedent.component';
...
describe('Component Tests', () => {
  describe('TypeAntecedent Management Component', () => {
    let comp: TypeAntecedentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeAntecedentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeAntecedents && comp.typeAntecedents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
