...
import { ImmoComponent } from 'app/entities/immo/immo.component';
import { ImmoService } from 'app/entities/immo/immo.service';
import { Immo } from 'app/shared/model/immo.model';

describe('Component Tests', () => {
  describe('Immo Management Component', () => {
    let comp: ImmoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ImmoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.immos && comp.immos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
