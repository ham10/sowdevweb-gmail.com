...
import { JourFerieComponent } from 'app/entities/jour-ferie/jour-ferie.component';
...
describe('Component Tests', () => {
  describe('JourFerie Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jourFeries && comp.jourFeries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
