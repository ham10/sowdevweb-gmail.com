...
import { TypeNotifComponent } from 'app/entities/type-notif/type-notif.component';
...
describe('Component Tests', () => {
  describe('TypeNotif Management Component', () => {
    let comp: TypeNotifComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeNotifComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeNotifs && comp.typeNotifs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
