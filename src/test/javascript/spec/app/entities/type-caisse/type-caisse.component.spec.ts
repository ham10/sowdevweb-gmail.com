...
import { TypeCaisseComponent } from 'app/entities/type-caisse/type-caisse.component';
...
describe('Component Tests', () => {
  describe('TypeCaisse Management Component', () => {
    let comp: TypeCaisseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeCaisseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeCaisses && comp.typeCaisses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
