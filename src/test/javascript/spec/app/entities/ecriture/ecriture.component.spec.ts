...
import { EcritureComponent } from 'app/entities/ecriture/ecriture.component';
...
describe('Component Tests', () => {
  describe('Ecriture Management Component', () => {
    let comp: EcritureComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EcritureComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ecritures && comp.ecritures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
