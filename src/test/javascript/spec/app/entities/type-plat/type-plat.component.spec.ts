...
import { TypePlatComponent } from 'app/entities/type-plat/type-plat.component';
...
describe('Component Tests', () => {
  describe('TypePlat Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typePlats && comp.typePlats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
