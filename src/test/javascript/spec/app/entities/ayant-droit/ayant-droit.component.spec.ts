...
import { AyantDroitComponent } from 'app/entities/ayant-droit/ayant-droit.component';
  ...
  describe('AyantDroit Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AyantDroitComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ayantDroits && comp.ayantDroits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
