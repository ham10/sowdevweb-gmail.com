...
describe('Service Tests', () => {
  describe('EtatOperation Service', () => {
    ...
    let elemDefault: IEtatOperation;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(EtatOperationService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new EtatOperation(0, 0, 'AAAAAAA', currentDate, currentDate, currentDate, 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a EtatOperation', () => {
        ...
        service.create(new EtatOperation()).subscribe(resp => (expectedResult = resp.body));
