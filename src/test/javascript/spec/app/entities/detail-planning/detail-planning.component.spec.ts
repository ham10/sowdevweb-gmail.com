...
import { DetailPlanningComponent } from 'app/entities/detail-planning/detail-planning.component';
...
describe('Component Tests', () => {
  describe('DetailPlanning Management Component', () => {
    let comp: DetailPlanningComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DetailPlanningComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.detailPlannings && comp.detailPlannings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
